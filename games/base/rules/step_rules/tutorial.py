...
import math
from utils import *
from games.base.rule import BaseStepRule, RuleContext, RuleResult, Event
from typing import Dict, Optional, Set, Tuple, List, Any
from games.base.world import NPC, Object, Area, Place, Path, Container, Writable
from games.base.agent import Agent
...
class TutorialRoomStepRule(BaseStepRule):
    ...
    STEPS: List[dict] = [
        {
            ...
            "done_any": [
                {"kind": "event", "type": "object_picked_up", "base_obj": "obj_small_bag"},
                {"kind": "state", "type": "in_hands_base", "base_obj": "obj_small_bag"},
            ],
        },
        {
            ...
            "done_any": [
                {"kind": "event", "type": "item_equipped", "base_obj": "obj_small_bag"},
                {"kind": "state", "type": "inventory_container_is_base", "base_obj": "obj_small_bag"},
            ],
        },
        {
        ...
        },
        {
            ...
            "setup": {},
            "instruction": (
                "Tutorial Step 4 — Unequip the bag so it is held in your hand.\n"
                "Required action: `unequip {bag}`\n"
            ),
            "done_any": [
                {"kind": "event", "type": "item_unequipped", "base_obj": "obj_small_bag"},
        ...
        },
        {
            ...
            "instruction": (
                "Tutorial Step 5 — Store a coin into the bag you are holding.\n"
        ...
        },
        {
            ...
            "setup": {},
            "instruction": (
                "Tutorial Step 6 — Inspect the bag to see its contents.\n"
                "Required action: `inspect {bag}`\n"
            ),
            "done_any": [
                {"kind": "event", "type": "container_inspected", "base_obj": "obj_small_bag"},
            ],
        },
        {
            ...
            "setup": {},
            "instruction": (
                "Tutorial Step 7 — Take the coin out of the bag to your hands.\n"
        ...
        },
        {
            ...
            "setup": {},
            "instruction": (
                "Tutorial Step 11 — Discard a coin from your inventory (it drops to the ground).\n"
        ...
        },
        {
            ...
            "setup": {},
            "instruction": (
                "Tutorial Step 14 — Write on the writable once you have writing tool.\n"
        ...
        },
        {
            ...
            "instruction": (
                ...
                "Make sure you have at least TWO coins in your possession (hand / inventory / held bag), not just on the ground.\n"
        ...
        },
        {
            ...
            "instruction": (
                ...
                "You can talk to NPCs to receive dialogue and hints.\n"
        ...
        },
        {
            ...
            "instruction": (
                "Tutorial Step 17 — Buy.\n"
                "A merchant is here. Buy ONE wood_log from the merchant.\n"
                "Note: items you buy will drop onto the ground.\n"
                "Required action: `buy 1 {wood_log} {merchant}`\n"
            ),
            "done_any": [
                {"kind": "event", "type": "object_bought", "base_obj": "obj_wood_log"},
            ],
        },
        {
            "id": "inspect_wood_log_crafting",
            "setup": {
                "ensure_npcs": [
                    {
                        "kind": "merchant",
                ...
                "ensure_ground_base_if_agent_missing": {"obj_wood_log": 1},
            },
            "instruction": (
                "Tutorial Step 18 — Inspect non-container objects.\n"
                "You'll receive hints about what can be crafted from a non-container object upon inspecting it.\n"
                "Required action: `inspect {wood_log}`\n"
            ),
            "done_any": [
                {"kind": "event", "type": "object_inspected", "base_obj": "obj_wood_log"},
            ],
        },
        {
            ...
            "instruction": (
                ...
                "Since bought items drop on the ground, pick it up first if needed.\n"
                "As your hands can hold at max 2 objects simultaneously, you need to empty one of your hands now if they are full.\n"
        ...
        },
        {
            ...
            "instruction": (
                ...
                "Since bought items drop on the ground, pick it up first if needed.\n"
                "Now with a hand emptied, you may pick up the wood_log.\n"
                "Required action: `pick up {wood_log}`\n"
            ),
            "done_any": [
                {"kind": "event", "type": "object_stored", "base_obj": "obj_wood_log"},
                {"kind": "event", "type": "object_picked_up", "base_obj": "obj_wood_log"},
                {"kind": "state", "type": "base_count_at_least", "base_obj": "obj_wood_log", "count": 1},
            ],
        },
        {
            ...
            "instruction": (
                "Tutorial Step 21 — Sell.\n"
                "Now sell ONE wood_log back to the merchant.\n"
                "The merchant will pay you coins for the item. The price is 0.5 times the item's value.\n"
                "Required action: `sell 1 {wood_log} {merchant}`\n"
            ),
            "done_any": [
                {"kind": "event", "type": "object_sold", "base_obj": "obj_wood_log"},
            ],
        },
        {
            ...
            "instruction": (
                "Tutorial Step 22 — Combat.\n"
                "Enemy NPCs may randomly attack you between steps.\n"
                "When you see an attack message, you can fight back using the `attack` action.\n"
                "They will drop their inventory items upon defeat.\n"
                "Now defeat this enemy NPC (it has extremely low HP):\n"
        ...
        {
            "id": "craft_prep_ironbar_and_stations",
            "setup": {"ensure_ground_base": {"obj_iron_bar": 1, "obj_workbench": 1, "obj_furnace": 1}},
            "instruction": (
                "Tutorial Step 23 — Craft prep (ingredients + dependencies).\n"
                "I placed:\n"
                "  - {iron_bar} (ingredient)\n"
                "  - {workbench} + {furnace} (dependencies)\n\n"
                "Now, make sure the iron bar is NOT just on the ground.\n"
                "Required action: `pick up {iron_bar}`\n"
            ),
            "done_any": [
                {"kind": "state", "type": "in_hands_base", "base_obj": "obj_iron_bar"},
                {"kind": "state", "type": "inventory_has_base", "base_obj": "obj_iron_bar"},
                {"kind": "state", "type": "held_containers_have_base", "base_obj": "obj_iron_bar"},
                {"kind": "event", "type": "object_picked_up", "base_obj": "obj_iron_bar"},
                {"kind": "event", "type": "object_stored", "base_obj": "obj_iron_bar"},
            ],
        },
        {
            "id": "craft_key_blank",
            "setup": {"ensure_ground_base": {"obj_workbench": 1, "obj_furnace": 1}},
            "instruction": (
                "Tutorial Step 24 — Craft a key blank (a necessary intermediate material in crafting a key).\n"
                "There are a lot objects you can craft in this game. A lot of them (i.e. weapons and armors) require multiple steps and intermediate materials.\n"
                "Required action: `craft 1 {key_blank}`\n"
            ),
            "done_any": [
                {"kind": "event", "type": "object_crafted", "base_obj": "obj_key_blank"},
            ],
        },
        {
            "id": "craft_prep_key_blank_pick_up",
            "setup": {"ensure_ground_base": {"obj_workbench": 1, "obj_furnace": 1}},
            "instruction": (
                "Tutorial Step 25 — Pick up the crafted key blank.\n"
                "Again, make sure that the key blank is NOT just on the ground.\n"
                "Required action: `pick up {key_blank}`\n"
            ),
            "done_any": [
                {"kind": "state", "type": "in_hands_base", "base_obj": "obj_key_blank"},
                {"kind": "state", "type": "inventory_has_base", "base_obj": "obj_key_blank"},
                {"kind": "state", "type": "held_containers_have_base", "base_obj": "obj_key_blank"},
                {"kind": "event", "type": "object_picked_up", "base_obj": "obj_key_blank"},
                {"kind": "event", "type": "object_stored", "base_obj": "obj_key_blank"},
            ],
        },
        {
            "id": "craft_key",
        ...
        },
        {
            ...
            "instruction": (
                ...
                "Now hold the key out on your hand for entering a locked area.\n"
        ...
        },
        {
            ...
            "setup": {"lock_exit": True},
            "instruction": (
                "Tutorial Step 28 — Enter.\n"
                "With the key in your hand, enter the locked area to leave the tutorial.\n"
    ...
    def _emit_completion_feedback(self, aid: str, res: RuleResult) -> None:
        ...
        from games.base.agent import Agent as gen_agent
        ...
        if extra_actions:
            actions_formatted = [
                f"- {action.verb} " + " ".join(f"<{p}>" for p in action.params) # + f": {action.description}"
    ...
    def _bootstrap(self, env, world, res: RuleResult) -> None:
        ...
        self._bag_inst_id, self._bag_name = self._create_instance(world, "obj_small_bag")
        ...
        for base_id in ("obj_coin", "obj_pen", "obj_iron_bar", "obj_workbench", "obj_furnace", "obj_key", "obj_wood_log"):
    ...
    def _render_instruction(self, world, step: dict) -> str:
        bag = self._bag_name or "small_bag"
        ...
        fmt = {
            ...
            "wood_log": world.objects["obj_wood_log"].name if "obj_wood_log" in world.objects else "wood_log",
            ...
            "key_blank": world.objects["obj_key_blank"].name if "obj_key_blank" in world.objects else "key_blank",
    ...
    def _cond_true(self, env, world, agent, cond: dict, events: list[Event]) -> bool:
        ...
        if kind == "state":
            ...
            if stype == "bag_in_hand_and_no_inventory":
                return self._has_base(agent.items_in_hands, "obj_small_bag") and (agent.inventory.container is None)
