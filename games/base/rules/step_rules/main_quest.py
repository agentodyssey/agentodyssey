...
class MainQuestStepRule(BaseStepRule):
    ...
    required_objects: List[Dict[str, Any]] = [
        ...
        "attack": 16, "description": "A tide-singing blade that bites hardest "
        "into ocean-borne bosses; against common foes it feels merely sharp.", 
        "craft": {"ingredients": {"obj_tide_alloy_ingot": 2, "obj_wooden_sword": 1, 
        "obj_heart_of_the_ocean": 1}, "dependencies": ["obj_workbench"]}, "level": 5},
    ]
    ...
    required_npcs: List[Dict[str, Any]] = [
        ...
        "objects": []},  # give very large base stats to avoid being killed accidentally
    ...
    QUEST_CONFIG: Dict[str, Any] = {
        ...
        "intro": (
            ...
            "One burns memory to ash.\n"
            "One keeps memory in deep, cold silence.\n\n"
        ),
        "chapters": [
            {
                "id": "chapter_1",
                "title": "The Furnace Oath",
                "intro": (
                    "Chapter 1: The Furnace Oath\n"
                    "Somebody in this world still remembers the old oath.\n"
                ...
                "stages": [
                    {
                        "id": "ch1_meet",
                        "objective": "Find the one who remembers the oath. Talk to {mq_guide_name} to learn more.",
                        "done_any": [{"kind": "state", "type": "in_area_with_npc", "npc_key": "ch1_guide_npc"}],
                        "on_complete_feedback": (
                            "{ch1_guide_name} says:\n"
                            "'Carry this number in your head.\n"
                            "The oath is: {ch1_oath_number}.'\n"
                            "Then, quietly:\n"
                            "'The Cinder Shrine is in one of these regions:\n"
                            " {ch1_shrine_candidates}\n"
                            "You’ll know what to do when you stand before it.'\n"
                        ),
                    },
                    {
                        "id": "ch1_prepare",
                        "objective": "Craft a weapon that respects strength over excuses.",
                        "hint": "You’ll want a blade you can rely on. A wooden one is always the easiest to make.",
                        "done_any": [
                            {"kind": "state", "type": "has_any_of", "base_objs": [
                                "obj_wooden_sword", "obj_stone_sword", "obj_iron_sword",
                                "obj_star_metal_sword", "obj_water_sword"
                            ]},
                        ],
                        "on_complete_feedback": (
                            "Good.\n"
                            "Now find the Cinder Shrine. "
                    ...
                    },
                    {
                        ...
                        "objective": "Find the Cinder Shrine.",
                        "hint": "It’s in one of the candidate regions you were told earlier.",
                        "done_all": [
                        ...
                        "on_complete_feedback": (
                            ...
                            "'THE OATH IS WHAT YOU REMEMBER.'\n"
                            "\n"
                            "Leave the oath here — exactly as you were told.\n"
                        ),
                    },
                    {
                        "id": "ch1_memory",
                        "objective": "Prove you remember the oath by dropping a paper with the correct number here.",
                        "hint": "Exactly. Numbers only.",
                        "done_all": [
                            {"kind": "state", "type": "in_area", "area_key": "ch1_shrine_area"},
                            {"kind": "state", "type": "paper_text_equals_in_area", "text_key": "ch1_oath_number"},
                        ],
                        "on_complete_feedback": (
                            "Ash rises.\n"
                            "A guardian wakes.\n"
                    ...
                    {
                        "id": "ch1_boss",
                        "objective": "Defeat the shrine guardian.",
                        "hint": "This one is a warm-up. It can fall even to a simple blade.",
                        "done_any": [
                        ...
                        "on_complete_feedback": (
                            ...
                            "\n"
                            "=== Chapter 1 Complete ===\n"
                            "A rumor spreads: a tide-merchant sells an ocean-luxury no ordinary shop carries.\n"
                        ),
                        "gives_coins": 12,
                ...
                "stages": [
                    {
                        ...
                        "on_complete_feedback": (
                            ...
                            "'Keep it close.\n"
                            "And remember this word: {ch2_salt_word}.\n"
                            "Not now. Later.\n"
                            "\n"
                    ...
                    },
                    {
                        ...
                        "objective": "Discover the lair of the furnace-walker.",
                        "hint": "You were given candidate regions. Explore until you find the truth.",
                        "done_all": [
                            {"kind": "state", "type": "visited_k_of_area_set", "area_set_key": "ch2_lair_candidate_areas", "k_key": "ch2_explore_min"},
                        ...
                        "on_complete_feedback": (
                            ...
                            "\n"
                            "You know what word it wants.\n"
                        ),
                    },
                    {
                        "id": "ch2_memory",
                        "objective": "Prove you remember what the tide-merchant made you keep in mind.",
                        "hint": "Exactly. No extra words.",
                        "done_all": [
                            {"kind": "state", "type": "in_area", "area_key": "ch2_boss_area"},
                    ...
                    {
                        "id": "ch2_boss",
                        "objective": "Defeat what waits in the lair.",
                        "hint": (
                            "Weak blades will feel like lies.\n"
                            "Iron and patience can work.\n"
                            "The sea’s answer works faster.\n"
                            "If you fall, it will not stay wounded.\n"
                        ),
                        "done_any": [
                        ...
                        "on_complete_feedback": (
                            ...
                            "\n"
                            "=== QUEST COMPLETE: The Tide and the Ember ===\n"
                            "You proved memory under pressure, and craft under threat.\n"
                        ),
                        "quest_complete": True,
                    },
                ],
    ...
    def _bootstrap(self, env, world) -> None:
        ...
        guide_picks = pick_progressive(1)
        self._generated["ch1_guide_area"] = guide_picks[0] if guide_picks else spawn_area
        shrine_cands = pick_progressive(3)
        if not shrine_cands:
            shrine_cands = [spawn_area]
        self._generated["ch1_shrine_candidate_areas"] = shrine_cands
        self._generated["ch1_shrine_area"] = max(
            shrine_cands, key=lambda a: dist.get(a, 0)
        )

        # Chapter 2
        self._generated["ch2_salt_word"] = "brine"
        merchant_picks = pick_progressive(1)
        self._generated["ch2_merchant_area"] = merchant_picks[0] if merchant_picks else spawn_area
        lair_cands = pick_progressive(3)
        if not lair_cands:
            lair_cands = [spawn_area]
        self._generated["ch2_lair_candidate_areas"] = lair_cands
        self._generated["ch2_boss_area"] = max(
            lair_cands, key=lambda a: dist.get(a, 0)
        )
    ...
    def _ensure_bosses_for_progress(self, env, world, prog: Dict[str, Any]) -> None:
        ...
        # only spawn once the story is at/after the “memory gate” for that chapter
        if ch == 0 and st >= 3:
    ...
    def _render_text(self, text: str, extra: Optional[Dict[str, str]] = None) -> str:
        ...
        fmt = {
            ...
            "ch1_boss_name": self._generated.get("ch1_boss_name", "cinder_reaver"),
            "ch2_boss_name": self._generated.get("ch2_boss_name", "ember_warden"),
