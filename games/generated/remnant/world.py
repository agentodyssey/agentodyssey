...
class World:
    ...
    def _assign_npcs_to_areas(world_definition: dict, rng: random.Random, places: Dict[str, Place], area_instances: Dict[str, Area], 
        ...
        for home in distributable_area_list:
            enemy_count = rng.randint(math.floor(home.level / 2), math.ceil(home.level / 1.5))  # make enemy count progress with area level
...
if __name__ == "__main__":
    world_definition = json.load(open("assets/world_definitions/generated/remnant/default.json"))
