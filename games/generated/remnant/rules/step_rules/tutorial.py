...
class TutorialRoomStepRule(BaseStepRule):
    ...
    STEPS: List[dict] = [
        ...
        {
            "id": "craft_prep_key_blank_and_stations",
            "setup": {"ensure_ground_base": {"obj_key_blank": 1, "obj_workbench": 1, "obj_furnace": 1}},
            "instruction": (
                "Tutorial Step 23 — Craft prep (ingredients + dependencies).\n"
                "I placed:\n"
                "  - {key_blank} (ingredient)\n"
        ...
        },
        {
            ...
            "instruction": (
                "Tutorial Step 25 — Pick up the key.\n"
        ...
        },
        {
            ...
            "setup": {"lock_exit": True},
            "instruction": (
                "Tutorial Step 26 — Enter an area.\n"
    ...
    def _emit_completion_feedback(self, aid: str, res: RuleResult) -> None:
        ...
        from games.generated.remnant.agent import Agent as gen_agent
    ...
    def _cleanup_and_remove(self, env, world, res: RuleResult) -> None:
        ...
        tutorial_base_ids = {
            ...
            "obj_furnace",
            "obj_key",
            "obj_key_blank",  # crafted during tutorial
            "obj_small_bag",
            "obj_paper",
        }
        for agent in env.agents:
